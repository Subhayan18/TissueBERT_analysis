#!/bin/bash
# Quick Evaluation Script for Phase 2
...
echo "Results saved to: /home/chattopa/data_storage/MethAtlas_WGBSanalysis/mixture_deconvolution_results/phase2_multitissue/evaluation"
echo ""
echo "View report:"
echo "  cat /home/chattopa/data_storage/MethAtlas_WGBSanalysis/mixture_deconvolution_results/phase2_multitissue/evaluation/evaluation_report.txt"
echo ""
echo "View figures:"
echo "  ls /home/chattopa/data_storage/MethAtlas_WGBSanalysis/mixture_deconvolution_results/phase2_multitissue/evaluation/figures/"
